<template>
  <div>
    ...
    <nav class="nav nav-1">
      <SideBarItem :items="nav1Items" />
    </nav>
    <div class="devide"></div>
    <div class="middle">
      <nav class="nav nav-2">
        <SideBarItem :items="nav2Items" />
      </nav>
    </div>
    <div class="bottom">
  ...
  data() {
    return {
      nav1Items: [
        ...
        { title: 'Theo Dõi', icon: 'ic-feed', slug: '#1' }
      ],
      nav2Items: [
        { title: 'Nhạc Mới', icon: 'ic-mn-song', slug: '/new-music' },
        { title: 'Thể Loại', icon: 'ic-mn-catalogue', slug: '#2' },
        { title: 'Top 100', icon: 'ic-mn-top100', slug: '#3' },
        { title: 'MV', icon: 'ic-mn-mv', slug: '#4' }
      ],
      isExpanded: false
    }
  },
